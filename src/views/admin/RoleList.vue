...
<script>
    ...
    export default {
        ...
        methods: {
            getData(){
                this.loading=true
                this.$service.role.list(this.form).then(res=>{
            ...
            toAdd(){
                this.$router.push({name:'role-save'})
            },
            toMore(item){
                this.$router.push({name:'OrderInfo',params:{id:item.id}})
            },
            toEdit(item){
                this.$router.push({name:'role-update',params:{id:item.id}})
            },
            doDelete(item){
                this.$dialog.confirm('确认删除吗？','','确认删除').then(res=>{
                    this.$service.role.del(item).then(res=>{
